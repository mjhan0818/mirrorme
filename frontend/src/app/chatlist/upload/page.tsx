  ...
  async function handleFileList(list: FileList | null) {
    ...
    for (const f of Array.from(list)) {
      ...
      try {
        ...
        // Save to sessionStorage so chat page can read it
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden">
        <div className="p-4 border-b flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">미오에게 최근 메신저 대화를 보내주세요</div>
            </div>
          </div>
        ...
        <div className="p-4">
          <div className="border border-dashed border-gray-300 rounded-lg p-6 text-center">
            <div className="mb-3 text-gray-500">500KB 이하의 txt 파일만 등록할 수 있습니다.</div>
            <div className="mb-4">
              <button
          ...
          <div className="mt-6 px-2">
            <button
              onClick={() => {
                if (!sessionStorage.getItem("full_chat")) {
                  setMessage("업로드한 파일이 없습니다. 먼저 파일을 업로드하세요.");
                  return;
                }
                router.push("/chat");
              }}
